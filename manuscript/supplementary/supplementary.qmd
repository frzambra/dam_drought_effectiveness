...
Figure S7 the barren-land ET-confound demonstration and Supplementary Figure S8 the
non-parametric aridity common-support check; Supplementary
...
outcomes; Supplementary Table S22 the geomorphological (alluvial) confound check; Supplementary
Table S23 the carryover-capacity context for the treated reservoirs; and Supplementary Table S24
the early/late megadrought phase split of the streamflow buffering and placebo tests.
Supplementary Table S25 is the direct within-basin test of the upstream/downstream placebo
contrast; Supplementary Table S26 the permutation inference for the within-region (siting-ladder
rung 4) residual; Supplementary Table S27 the permutation inference for the megadrought phase
shift; Supplementary Tables S28 and S29 the non-linear (quadratic) and dry-tail transmission
checks; Supplementary Table S30 the catchment-area comparability check; Supplementary Table S31
the elevation-adjusted placebo; Supplementary Table S32 the gauge-classification robustness of the
contrast; Supplementary Table S33 the cumulative-scale (discharge-adjusted) placebo; Supplementary
Table S34 the paired-placebo contrast power; and Supplementary Table S35 the storage-capacity
(carryover) heterogeneity of the buffering test. The
downstream extraction-masking bound (the downstream-versus-upstream cropland gradient, the control
transmission-slope sensitivity to local extraction, and the predicted masking magnitude) is
Supplementary Table S36, the placebo net of a SPEI-by-local-cropland interaction is Supplementary
Table S37, the sub-watershed SPEI exposure-misclassification bound is Supplementary Table S38, the
strictly-paired carryover contrast is Supplementary Table S39, and the carryover-ratio
denominator sensitivity (unregulated upstream flow) is Supplementary Table S40. Supplementary
Table S41 decomposes the storage-band decline into a 2010 level step versus a continuing drift,
and Supplementary Table S42 reports the carryover-claim hardening checks (the irrigation-only,
hydropower-excluded contrast and the leave-one-out permutation inference). Supplementary Table
S43 screens the upstream placebo for cascade-dam contamination against the 1,370-dam national
inventory and re-runs the placebo without flagged gauges; Supplementary Table S44 re-fits the
storage-band trends weighted by reservoir capacity and in absolute fleet volumes; and
Supplementary Table S45 reports the hard-balance weight diagnostics and the naive and
re-balanced leave-one-out sensitivities. Supplementary Table S46 validates the
upstream/downstream gauge classification against the HydroRIVERS routed network and re-runs the
placebo on network-connected gauges only; Supplementary Table S47 replaces the year fixed
effects with a cubic national time trend so the temporal drought signal is retained;
Supplementary Table S48 re-tests the aggregate and carryover contrasts under an
elevation-partitioned permutation null; Supplementary Table S49 re-derives the streamflow
results with SSI standardized on the 1990–2020 baseline; Supplementary Table S50 quantifies the
drought-conditional structure of streamflow missingness; Supplementary Table S51 re-fits the
storage-band trends on the coverage-stable reservoir subset; Supplementary Table S52 adds
quadratic aridity-by-forcing interactions to the buffering model; and Supplementary Table S53
screens the matched controls against the 1,370-dam national inventory and re-fits the
streamflow results with a re-balanced dam-free control pool. Supplementary Table S54 confirms
every storage-band trend, step, and drift coefficient with a null-imposed wild cluster
bootstrap, the small-cluster refinement appropriate to the 22 to 26 reservoir clusters. All items are regenerated by the `targets` pipeline.
...
Supplementary Table S8, and the aridity-overlap subset with its spatial-block inference, a
different sample and permutation scheme, is Supplementary Table S9). A conventional matched
...
**Supplementary Figure S8 | Baseline aridity: non-parametric common support.** Densities of
...
extrapolation. The hard-balanced sensitivity (Supplementary Table S17), which removes the residual
...
Table S45; the hard balance is corroborating, not load-bearing.
...
**Supplementary Table S24 | Early/late megadrought phase split of the streamflow buffering and
...
(2010–2014), when reservoirs entered near-full (peak 87% of capacity, Supplementary Table S5) and
...
**Supplementary Table S25 | Direct test of the upstream/downstream placebo contrast.** The
...
**Supplementary Table S26 | Within-region residual (siting-ladder rung 4), permutation
...
removed (rung 4 of Supplementary Fig. S3 and Table S4), reported with its own permutation null:
...
**Supplementary Table S27 | Permutation inference for the megadrought phase shift.** The
...
**Supplementary Table S28 | Non-linear transmission test.** A quadratic SPEI term interacted
...
**Supplementary Table S29 | Dry-tail re-estimates of the buffering and placebo tests.** The
...
**Supplementary Table S30 | Catchment-area comparability of the placebo.** The unit-area gap
...
capture, is tested with gauge discharge in Supplementary Table S33.
...
**Supplementary Table S31 | Elevation-adjusted placebo.** The buffering model re-fit with a
...
**Supplementary Table S32 | Gauge-classification robustness of the placebo contrast.** The
...
**Supplementary Table S33 | Cumulative-scale (discharge-adjusted) placebo.** Because larger
...
**Supplementary Table S34 | Paired-placebo contrast power.** The minimum detectable
...
**Supplementary Table S35 | Storage-capacity (carryover) heterogeneity of the buffering test.**
...
$p = 0.26$). This split is an exploratory, reviewer-prompted subgroup analysis and carries no
multiplicity adjustment; its hardening battery is in Supplementary Tables S39 (strict pairing),
S40 (denominator sensitivity), and S42 (hydropower exclusion and leave-one-out inference).
...
**Supplementary Table S36 | Downstream extraction masking.** The up/down placebo compares
...
**Supplementary Table S37 | Placebo net of a SPEI-by-local-cropland interaction.** The direct
...
**Supplementary Table S38 | Sub-watershed SPEI exposure misclassification.** Upstream and
...
**Supplementary Table S39 | Strictly-paired carryover contrast.** The capacity split (7
...
**Supplementary Table S40 | Carryover-ratio denominator sensitivity.** The carryover ratio
...
**Supplementary Table S41 | Storage-band step-versus-trend decomposition.** The storage decline
...
($-0.010$ yr^-1^, $p = 0.007$). The full-window linear trend of Supplementary Table S5 therefore
...
**Supplementary Table S42 | Carryover-claim hardening: hydropower exclusion and leave-one-out
...
**Supplementary Table S43 | Cascade-dam contamination screen of the upstream placebo.** The
...
(the ICOLD large-dam threshold); dam elevations are SRTM, the paper's classification convention.
...
**Supplementary Table S44 | Capacity-weighted and absolute-volume storage-band trends.** The
...
Supplementary Table S54, under which the weighted trough trend and drift and the amplitude widening
...
**Supplementary Table S45 | Hard-balance weight diagnostics and leave-one-out sensitivity.**
...
**Supplementary Table S46 | Routed-network validation of the upstream/downstream
...
**Supplementary Table S47 | Buffering under a smooth national time trend.** Year fixed effects
...
**Supplementary Table S48 | Elevation-partitioned permutation null for the placebo contrast.**
...
**Supplementary Table S49 | SSI standardized on the 1990–2020 baseline.** The primary SSI uses
...
(31 years; the CR2 daily record begins in 1900) leaves the estimation window unchanged and
...
**Supplementary Table S50 | Drought-conditional streamflow missingness.** The no-imputation
...
thin the placebo rather than protect it. The dry-tail re-estimates (Supplementary Table S29)
and the long-baseline SSI (Supplementary Table S49) carry the same verdict on the retained
months.
...
**Supplementary Table S51 | Storage-band trends on the coverage-stable subset.** Several
...
**Supplementary Table S52 | Non-linear aridity-by-forcing sensitivity.** Drought transmission
...
**Supplementary Table S53 | Control screening against the national dam inventory.** "Undammed"
...
**Supplementary Table S54 | Wild-cluster-bootstrap inference for the storage-band models.**
...
Supplementary Table S44 for those three coefficients over-reject and the step evidence rests on the
unweighted fit.
